...
`,
    ...
    'info_society_intro': {
        ...
        <h3>المحور الأول: ماهية مجتمع المعلومات وتطوره</h3>
        ...
        <hr>
        <h3>المحور الثاني: أنماط المجتمعات ومنظرو التحول</h3>
        ...
        <hr>
        <h3>المحور الثالث: ظروف وخصائص مجتمع المعلومات</h3>
        ...
        <hr>
        <h3>المحور الرابع: الإنترنت، السياسة، والاقتصاد الجديد</h3>
        <h4>الإنترنت:</h4>
        ...
        <hr>
        <h3>المحور الخامس: الثقافة والمراقبة في المجتمع الشبكي</h3>
    ...
    <hr>
    <h3>المحور الثاني: الحضارة الفارسية وعوامل قيام الحضارات</h3>
    ...
    <hr>
    <h3>المحور الثالث: فجر التاريخ وحضارة بلاد الرافدين</h3>
    ...
    <hr>
    <h3>المحور الرابع: عصور الحضارة المصرية</h3>
    <ul>
    ...
    <hr>
    <h3>المحور الخامس: مصادر دراسة الحضارات</h3>
...
`,
    ...
    semester: 1, 
    summary: `
        <h2>المحور الأول: مفهوم العلوم الإنسانية ونشأتها</h2>
        ...
        <h2>المحور الثاني: الظاهرة الإنسانية وعوائق دراستها العلمية</h2>
        ...
        <h2>المحور الثالث: الإبستمولوجيا وعلاقتها بالعلوم الأخرى</h2>
